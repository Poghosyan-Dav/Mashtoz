...
import '../../../../domens/blocs/update_home_state.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _fetchHomeData(bool isFromPullRefresh) async {
    ...
    homeDataFuture =
        _bookDataProvider.getHomeData(isFromPullRefresh).then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    return ConnectivityBuilder(builder: (context, isConnect, status) {
      if (isConnect == true) {
        if (libraries != null) {
          return SafeArea(
            child: Theme(
              ...
              child: Scaffold(
                  ...
                  body: BlocBuilder<MyBloc, MyState>(
                    builder: (context, state) {
                      bool? isTrue;
                      if (state is ScreenUpdatedState) {
                        // You can access the current bool value here:
                        isTrue = state.isTrue;

                        print('isTrue1 $isTrue');

                        if (isTrue) _refreshData();
                      }
                      print('isTrue2 $isTrue');
                      return isTrue!
                          ? const Center(
                                                                  ...
                                                                  child: Align(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: ResponsiveGridListBuilder(
                                                                            ...
                                                                            gridItems: List.generate(libraries!.content!.values.map((e) => e).toList().length, (index) {
                                                                              var bookData;

                                                                              if (libraries != null) {
                                                                                bookData = libraries!.content!.values.map((e) => e).toList();
                                                                                books = bookData[index];
                                                                                ...
                                                                                return index % 2 != 0
                                                                                    ? Transform(
                                                                                        ...
                                                                                        child: Padding(
                                                                                          ...
                                                                                          child: BookCard(
                                                                                            isOdd: true,
                                                                                            isFromHomePage: true,
                                                                                            categorys: BookCategory(categoryTitle: books?.title!, id: books?.id!, title: '${books?.title}', type: 'libraries'),
                                                                                            book: books!,
                                                                                            bookId: books?.id,
                                                                                          ),
                                                                                        ))
                                                                                    : Padding(
                                                                                        ...
                                                                                        child: BookCard(
                                                                                          isOdd: false,
                                                                                          isFromHomePage: true,
                                                                                          categorys: BookCategory(categoryTitle: books?.title ?? '', id: books?.id ?? 0, title: '${books?.title}', type: 'libraries'),
                                                                                          bookId: books?.id,
                                                                                          book: books!,
                                                                                        ),
                                                                                      );
                                                                ...
                                                                child: Stack(
                                                                  children: [
                                                                    Positioned
                                                                      ...
                                                                      child:
                                                                          Align(
                                                                        alignment: SizeConfig.orentation ==
                                                                    ...
                                                                    const Positioned
                                                                        ...
                                                                        child: Align(
                                                                            ...
                                                                            child: Text(
                                                                              'Իտալերենի դասեր',
                                                                              style: TextStyle(fontFamily: 'GHEAGrapalat', fontSize: 16.0, letterSpacing: 1, fontWeight: FontWeight.w400, color: Color.fromRGBO(122, 108, 115, 1)),
                                                                            ))),
                                                                  ],
                                                                ),
                                                              ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          mainAxisSize:
                                                                              MainAxisSize.min,
                                                                          children: [
                                                                            _buildEncyclopediaContainer(context),
                                                                            const SizedBox(width: 10.0),
                                                                            GestureDetector(
                                                                              onTap: () {
                                                                                Navigator.of(context, rootNavigator: true).push(
                                                                                  MaterialPageRoute(builder: (_) => const Ecyclopedia()),
                                                                                );
                                                                              },
                                                                              child: Container(
                                                                                  ...
                                                                                  itemBuilder: (BuildContext context, int index) {
                                                                                    ...
                                                                                    return Padding(
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        onTap: () {
                                                                                          if (character != null) {
                                                                                            final characterIndex = charEncyc.indexOf(character);
                                                                                            Navigator.of(context).push(
                                                                                              MaterialPageRoute(
                                                                                                builder: (_) => EcyclopediaByCharacters(
                                                                                                  characters: charEncyc,
                                                                                                  characterByindex: character,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Container(
                                                                                ...
                                                                                width: 84,
                                                                                decoration: BoxDecoration(
                                                                                  color: Color.fromRGBO(84, 126, 126, 1),
                                                                                  boxShadow: [
                                                                                    BoxShadow(
                                                                                      color: Color.fromRGBO(0, 0, 0, 0.1),
                                                                                      blurRadius: 1.0,
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        GestureDetector(
                                                                          onTap:
                                                                              () {
                                                                            Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(builder: (_) => const AudioLibrary()));
                                                                          },
                                                                          child:
                                                                              const Text(
                                                                            'Ձայանդարան',
                                                                        ...
                                                                        GestureDetector(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              color: const Color.fromRGBO(122, 108, 115, 1),
                                                                            )),
                                                                        const SizedBox(
                                                                            width:
                                                                                17),
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              style: TextStyle(
                                                                                fontFamily: "ArshaluyseArtU",
                                                                                fontSize: SizeConfig.screenWidth! >= 1200 ? 38 : 30,
                                                                                color: Palette.textLineOrBackGroundColor,
                                                                                fontWeight: FontWeight.w700,
                                                                              ),
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Align(
                                                                                ...
                                                                                child: a != null
                                                                                    ? CachedNetworkImage(
                                                                                        imageUrl: '${a?.first.image}',
                                                                                        width: double.infinity,
                                                                                        fit: BoxFit.cover,
                                                                                        height: SizeConfig.orentation == Orientation.landscape ? (SizeConfig.screenHeight! / 3.55) * 2 : SizeConfig.screenHeight! / 3.55,
                                                                                      )
                                                                                    : const CircularProgressIndicator(),
                                                                              ),
                                                                              Positioned.fill(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                GestureDetector(
                                                                                  onTap: () {
                                                                                    Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(builder: (_) => const Dialect()));
                                                                                  },
                                                                                  child: Align(
                                                                                    alignment: Alignment.topCenter,
                                                                                    child: const Text(
                                                                                      'Համաբարբառ ',
                                                                                      style: TextStyle(fontFamily: 'GHEAGrapalat', fontSize: 12, fontWeight: FontWeight.w700, letterSpacing: 1, color: Color.fromRGBO(164, 171, 189, 1)),
                                                                                    ),
                                                                                  ),
                                                                                ),
                                                                                const SizedBox(
                                                                                ...
                                                                                GestureDetector(
                                                                                    ...
                                                                                    child: Container(padding: EdgeInsets.only(top: 3), child: Align(alignment: Alignment.topCenter, child: SvgPicture.asset('assets/images/arrow_right.svg')))),
                                                                                const SizedBox(
                                                                                  width: 10.0,
                                                                                ),
                                                                                Container(
                                                                                  ...
                                                                                  child: ListView.builder(
                                                                                      ...
                                                                                      itemBuilder: (BuildContext context, index) {
                                                                                        return Padding(
                                                                                          ...
                                                                                          child: InkWell(
                                                                                            onTap: () {
                                                                                              if (dialects != null) Navigator.of(context).push(MaterialPageRoute(builder: (_) => DialectByCharacters(characters: charDialects, characterByindex: "${dialects?[index]}", characterIndex: charDialects.indexOf("${dialects?[index]}"))));
                                                                                            },
                                                                                            child: Text(
                                                                                              '${dialects?[index]},',
                                                                                              style: const TextStyle(fontFamily: 'GHEAGrapalat', fontSize: 12, fontWeight: FontWeight.w700, letterSpacing: 1, color: Color.fromRGBO(164, 171, 189, 1)),
                                                                                            ),
                                                                                          ),
                                                                                        );
                                                                                      }),
                                                                                  ...
                                                                                  children: [
                                                                                    Expanded(
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: GestureDetector(
                                                                                          onTap: () {
                                                                                            OpenUrl.launchInBrowser(Uri.parse(d!.first.sharurl.toString()));
                                                                                          },
                                                                                          child: _enabled
                                                                                              ? Text(
                                                                                                  '${!dailectData.isEmpty ? dailectData.first.title : d?.first.title}',
                                                                                                  style: const TextStyle(fontFamily: 'GHEAGrapalat', fontWeight: FontWeight.w700, fontSize: 16.0, color: Color.fromRGBO(97, 109, 135, 1)),
                                                                                                  textAlign: TextAlign.start,
                                                                                                )
                                                                                              : Padding(
                                                                                                  padding: EdgeInsets.only(top: 10, right: MediaQuery.of(context).size.width / 2),
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                              ...
                                                                              child: Container(
                                                                                height: 34,
                                                                                width: double.infinity,
                                                                                decoration: const BoxDecoration(color: Color.fromRGBO(113, 141, 156, 1), boxShadow: [
                                                                                  BoxShadow(
                                                                                    color: Color.fromRGBO(0, 0, 0, 0.1),
                                                                                    blurRadius: 1.0,
                                                                                    spreadRadius: 0.0,
                                                                                        ...
                                                                                        child: InkWell(
                                                                                          onTap: () {
                                                                                            ...
                                                                                            Future.delayed(const Duration(milliseconds: 300), () {
                                                                                              _bookDataProvider.getDataByCharacters(Api.dialectBYCharacters(dialects?[index])).then((value) {
                                                                                                setState(() {
                                                                                                  dailectData = value;
                                                                                                });
                                                                                              });
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Container(
                                                                                height: double.infinity,
                                                                                width: 84,
                                                                                decoration: const BoxDecoration(color: Color.fromRGBO(84, 126, 126, 1), boxShadow: [
                                                                                  BoxShadow(
                                                                                    color: Color.fromRGBO(0, 0, 0, 0.1),
                                                                                    blurRadius: 1.0,
                                                                                    spreadRadius: 0.0,
                                                                                    ...
                                                                                    child: Container(
                                                                                      ...
                                                                                      child: _enabled
                                                                                          ? Text(
                                                                                              ...
                                                                                              style: const TextStyle(color: Palette.whenTapedButton, fontFamily: 'ArshaluyseArtU', fontWeight: FontWeight.w700, fontSize: 52),
                                                                                            )
                                                                                          : const CircularProgressIndicator(
                                                                                              color: Palette.main,
                                                                                              strokeWidth: 2,
  ...
  Widget _buildEncyclopediaContainer(BuildContext context) {
