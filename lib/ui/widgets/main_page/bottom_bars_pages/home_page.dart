...
class _HomePageState extends State<HomePage> {
 ...
 Future<void> _fetchHomeData(bool isFromPullRefresh)async{
  ...
  homeDataFuture = _bookDataProvider.getHomeData(isFromPullRefresh).then((value) {
                  ...
                  child: Scaffold(
                      ...
                      body: BlocBuilder<MyBloc,MyState>(
                        builder: (context,state){
                         ...
                         return  isTrue! ? const Center(child:CircularProgressIndicator(color:Palette.main)):
                          ...
                          children: [
                          Container(
                          width: SizeConfig.screenWidth! >= 1200 ? 1200 : SizeConfig.screenWidth,
                          child: Stack(
                          children: [
                          Positioned.fill(top:10.0,
                          child:  Align(
                          alignment: Alignment.topCenter,
                          child:Container(
                          ...
                          await _bookDataProvider
                              .getDataByCharacters(Api.encyclopediasByCharacters(encyclopedias?[index]))
                              .then((value) {
                          setState(() {
                          encyData = value;
                          });
